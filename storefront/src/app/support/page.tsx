...
export const metadata: Metadata = {
  title: "Support",
  description:
    "HiTHIUM Bangladesh product support, warranty information, FAQ, and after-sales service.",
};
...
const faqs = [
  ...
  },
  {
    ...
    a: "Portable power stations (HeroEE 1 & 2) come with a 5-year warranty. Energy storage systems (HeroEE 8 & 16) come with a 10-year warranty. Warranty is serviced locally through HiTHIUM Bangladesh.",
  },
  {
          ...
          <Card className="border border-gray-100" shadow="sm">
            <CardBody className="p-6">
              ...
              <ul className="mt-4 space-y-1 text-sm text-gray-600">
                ...
                <li>Local service through HiTHIUM Bangladesh</li>
              </ul>
            </CardBody>
          </Card>
          <Card className="border border-gray-100" shadow="sm">
